...
pub unsafe fn xr_result_to_string(
    _instance: Instance,
    value: XrErr,
    buffer: &mut [c_char; MAX_RESULT_STRING_SIZE],
) -> XrResult {
    let string = match value {
        XrErr::SUCCESS => Some("SUCCESS"),
        XrErr::TIMEOUT_EXPIRED => Some("TIMEOUT_EXPIRED"),
        XrErr::SESSION_LOSS_PENDING => Some("SESSION_LOSS_PENDING"),
        XrErr::EVENT_UNAVAILABLE => Some("EVENT_UNAVAILABLE"),
        XrErr::SPACE_BOUNDS_UNAVAILABLE => Some("SPACE_BOUNDS_UNAVAILABLE"),
        XrErr::SESSION_NOT_FOCUSED => Some("SESSION_NOT_FOCUSED"),
        XrErr::FRAME_DISCARDED => Some("FRAME_DISCARDED"),
        XrErr::ERROR_VALIDATION_FAILURE => Some("ERROR_VALIDATION_FAILURE"),
        XrErr::ERROR_RUNTIME_FAILURE => Some("ERROR_RUNTIME_FAILURE"),
        XrErr::ERROR_OUT_OF_MEMORY => Some("ERROR_OUT_OF_MEMORY"),
        XrErr::ERROR_API_VERSION_UNSUPPORTED => Some("ERROR_API_VERSION_UNSUPPORTED"),
        XrErr::ERROR_INITIALIZATION_FAILED => Some("ERROR_INITIALIZATION_FAILED"),
        XrErr::ERROR_FUNCTION_UNSUPPORTED => Some("ERROR_FUNCTION_UNSUPPORTED"),
        XrErr::ERROR_FEATURE_UNSUPPORTED => Some("ERROR_FEATURE_UNSUPPORTED"),
        XrErr::ERROR_EXTENSION_NOT_PRESENT => Some("ERROR_EXTENSION_NOT_PRESENT"),
        XrErr::ERROR_LIMIT_REACHED => Some("ERROR_LIMIT_REACHED"),
        XrErr::ERROR_SIZE_INSUFFICIENT => Some("ERROR_SIZE_INSUFFICIENT"),
        XrErr::ERROR_HANDLE_INVALID => Some("ERROR_HANDLE_INVALID"),
        XrErr::ERROR_INSTANCE_LOST => Some("ERROR_INSTANCE_LOST"),
        XrErr::ERROR_SESSION_RUNNING => Some("ERROR_SESSION_RUNNING"),
        XrErr::ERROR_SESSION_NOT_RUNNING => Some("ERROR_SESSION_NOT_RUNNING"),
        XrErr::ERROR_SESSION_LOST => Some("ERROR_SESSION_LOST"),
        XrErr::ERROR_SYSTEM_INVALID => Some("ERROR_SYSTEM_INVALID"),
        XrErr::ERROR_PATH_INVALID => Some("ERROR_PATH_INVALID"),
        XrErr::ERROR_PATH_COUNT_EXCEEDED => Some("ERROR_PATH_COUNT_EXCEEDED"),
        XrErr::ERROR_PATH_FORMAT_INVALID => Some("ERROR_PATH_FORMAT_INVALID"),
        XrErr::ERROR_PATH_UNSUPPORTED => Some("ERROR_PATH_UNSUPPORTED"),
        XrErr::ERROR_LAYER_INVALID => Some("ERROR_LAYER_INVALID"),
        XrErr::ERROR_LAYER_LIMIT_EXCEEDED => Some("ERROR_LAYER_LIMIT_EXCEEDED"),
        XrErr::ERROR_SWAPCHAIN_RECT_INVALID => Some("ERROR_SWAPCHAIN_RECT_INVALID"),
        XrErr::ERROR_SWAPCHAIN_FORMAT_UNSUPPORTED => Some("ERROR_SWAPCHAIN_FORMAT_UNSUPPORTED"),
        XrErr::ERROR_ACTION_TYPE_MISMATCH => Some("ERROR_ACTION_TYPE_MISMATCH"),
        XrErr::ERROR_SESSION_NOT_READY => Some("ERROR_SESSION_NOT_READY"),
        XrErr::ERROR_SESSION_NOT_STOPPING => Some("ERROR_SESSION_NOT_STOPPING"),
        XrErr::ERROR_TIME_INVALID => Some("ERROR_TIME_INVALID"),
        XrErr::ERROR_REFERENCE_SPACE_UNSUPPORTED => Some("ERROR_REFERENCE_SPACE_UNSUPPORTED"),
        XrErr::ERROR_FILE_ACCESS_ERROR => Some("ERROR_FILE_ACCESS_ERROR"),
        XrErr::ERROR_FILE_CONTENTS_INVALID => Some("ERROR_FILE_CONTENTS_INVALID"),
        XrErr::ERROR_FORM_FACTOR_UNSUPPORTED => Some("ERROR_FORM_FACTOR_UNSUPPORTED"),
        XrErr::ERROR_FORM_FACTOR_UNAVAILABLE => Some("ERROR_FORM_FACTOR_UNAVAILABLE"),
        XrErr::ERROR_API_LAYER_NOT_PRESENT => Some("ERROR_API_LAYER_NOT_PRESENT"),
        XrErr::ERROR_CALL_ORDER_INVALID => Some("ERROR_CALL_ORDER_INVALID"),
        XrErr::ERROR_GRAPHICS_DEVICE_INVALID => Some("ERROR_GRAPHICS_DEVICE_INVALID"),
        XrErr::ERROR_POSE_INVALID => Some("ERROR_POSE_INVALID"),
        XrErr::ERROR_INDEX_OUT_OF_RANGE => Some("ERROR_INDEX_OUT_OF_RANGE"),
        XrErr::ERROR_VIEW_CONFIGURATION_TYPE_UNSUPPORTED => {
            Some("ERROR_VIEW_CONFIGURATION_TYPE_UNSUPPORTED")
        }
        XrErr::ERROR_ENVIRONMENT_BLEND_MODE_UNSUPPORTED => {
            Some("ERROR_ENVIRONMENT_BLEND_MODE_UNSUPPORTED")
        }
        XrErr::ERROR_NAME_DUPLICATED => Some("ERROR_NAME_DUPLICATED"),
        XrErr::ERROR_NAME_INVALID => Some("ERROR_NAME_INVALID"),
        XrErr::ERROR_ACTIONSET_NOT_ATTACHED => Some("ERROR_ACTIONSET_NOT_ATTACHED"),
        XrErr::ERROR_ACTIONSETS_ALREADY_ATTACHED => Some("ERROR_ACTIONSETS_ALREADY_ATTACHED"),
        XrErr::ERROR_LOCALIZED_NAME_DUPLICATED => Some("ERROR_LOCALIZED_NAME_DUPLICATED"),
        XrErr::ERROR_LOCALIZED_NAME_INVALID => Some("ERROR_LOCALIZED_NAME_INVALID"),
        XrErr::ERROR_GRAPHICS_REQUIREMENTS_CALL_MISSING => {
            Some("ERROR_GRAPHICS_REQUIREMENTS_CALL_MISSING")
        }
        XrErr::ERROR_RUNTIME_UNAVAILABLE => Some("ERROR_RUNTIME_UNAVAILABLE"),
        XrErr::ERROR_ANDROID_THREAD_SETTINGS_ID_INVALID_KHR => {
            Some("ERROR_ANDROID_THREAD_SETTINGS_ID_INVALID_KHR")
        }
        XrErr::ERROR_ANDROID_THREAD_SETTINGS_FAILURE_KHR => {
            Some("ERROR_ANDROID_THREAD_SETTINGS_FAILURE_KHR")
        }
        XrErr::ERROR_CREATE_SPATIAL_ANCHOR_FAILED_MSFT => {
            Some("ERROR_CREATE_SPATIAL_ANCHOR_FAILED_MSFT")
        }
        XrErr::ERROR_SECONDARY_VIEW_CONFIGURATION_TYPE_NOT_ENABLED_MSFT => {
            Some("ERROR_SECONDARY_VIEW_CONFIGURATION_TYPE_NOT_ENABLED_MSFT")
        }
        XrErr::ERROR_CONTROLLER_MODEL_KEY_INVALID_MSFT => {
            Some("ERROR_CONTROLLER_MODEL_KEY_INVALID_MSFT")
        }
        XrErr::ERROR_REPROJECTION_MODE_UNSUPPORTED_MSFT => {
            Some("ERROR_REPROJECTION_MODE_UNSUPPORTED_MSFT")
        }
        XrErr::ERROR_COMPUTE_NEW_SCENE_NOT_COMPLETED_MSFT => {
            Some("ERROR_COMPUTE_NEW_SCENE_NOT_COMPLETED_MSFT")
        }
        XrErr::ERROR_SCENE_COMPONENT_ID_INVALID_MSFT => {
            Some("ERROR_SCENE_COMPONENT_ID_INVALID_MSFT")
        }
        XrErr::ERROR_SCENE_COMPONENT_TYPE_MISMATCH_MSFT => {
            Some("ERROR_SCENE_COMPONENT_TYPE_MISMATCH_MSFT")
        }
        XrErr::ERROR_SCENE_MESH_BUFFER_ID_INVALID_MSFT => {
            Some("ERROR_SCENE_MESH_BUFFER_ID_INVALID_MSFT")
        }
        XrErr::ERROR_SCENE_COMPUTE_FEATURE_INCOMPATIBLE_MSFT => {
            Some("ERROR_SCENE_COMPUTE_FEATURE_INCOMPATIBLE_MSFT")
        }
        XrErr::ERROR_SCENE_COMPUTE_CONSISTENCY_MISMATCH_MSFT => {
            Some("ERROR_SCENE_COMPUTE_CONSISTENCY_MISMATCH_MSFT")
        }
        XrErr::ERROR_DISPLAY_REFRESH_RATE_UNSUPPORTED_FB => {
            Some("ERROR_DISPLAY_REFRESH_RATE_UNSUPPORTED_FB")
        }
        XrErr::ERROR_COLOR_SPACE_UNSUPPORTED_FB => Some("ERROR_COLOR_SPACE_UNSUPPORTED_FB"),
        XrErr::ERROR_SPACE_COMPONENT_NOT_SUPPORTED_FB => {
            Some("ERROR_SPACE_COMPONENT_NOT_SUPPORTED_FB")
        }
        XrErr::ERROR_SPACE_COMPONENT_NOT_ENABLED_FB => {
            Some("ERROR_SPACE_COMPONENT_NOT_ENABLED_FB")
        }
        XrErr::ERROR_SPACE_COMPONENT_STATUS_PENDING_FB => {
            Some("ERROR_SPACE_COMPONENT_STATUS_PENDING_FB")
        }
        XrErr::ERROR_SPACE_COMPONENT_STATUS_ALREADY_SET_FB => {
            Some("ERROR_SPACE_COMPONENT_STATUS_ALREADY_SET_FB")
        }
        XrErr::ERROR_UNEXPECTED_STATE_PASSTHROUGH_FB => {
            Some("ERROR_UNEXPECTED_STATE_PASSTHROUGH_FB")
        }
        XrErr::ERROR_FEATURE_ALREADY_CREATED_PASSTHROUGH_FB => {
            Some("ERROR_FEATURE_ALREADY_CREATED_PASSTHROUGH_FB")
        }
        XrErr::ERROR_FEATURE_REQUIRED_PASSTHROUGH_FB => {
            Some("ERROR_FEATURE_REQUIRED_PASSTHROUGH_FB")
        }
        XrErr::ERROR_NOT_PERMITTED_PASSTHROUGH_FB => Some("ERROR_NOT_PERMITTED_PASSTHROUGH_FB"),
        XrErr::ERROR_INSUFFICIENT_RESOURCES_PASSTHROUGH_FB => {
            Some("ERROR_INSUFFICIENT_RESOURCES_PASSTHROUGH_FB")
        }
        XrErr::ERROR_UNKNOWN_PASSTHROUGH_FB => Some("ERROR_UNKNOWN_PASSTHROUGH_FB"),
        XrErr::ERROR_RENDER_MODEL_KEY_INVALID_FB => Some("ERROR_RENDER_MODEL_KEY_INVALID_FB"),
        XrErr::RENDER_MODEL_UNAVAILABLE_FB => Some("RENDER_MODEL_UNAVAILABLE_FB"),
        XrErr::ERROR_MARKER_NOT_TRACKED_VARJO => Some("ERROR_MARKER_NOT_TRACKED_VARJO"),
        XrErr::ERROR_MARKER_ID_INVALID_VARJO => Some("ERROR_MARKER_ID_INVALID_VARJO"),
        XrErr::ERROR_SPATIAL_ANCHOR_NAME_NOT_FOUND_MSFT => {
            Some("ERROR_SPATIAL_ANCHOR_NAME_NOT_FOUND_MSFT")
        }
        XrErr::ERROR_SPATIAL_ANCHOR_NAME_INVALID_MSFT => {
    ...
    copy_str_to_buffer(&string, buffer);
...
pub unsafe fn xr_structure_type_to_string(
    _instance: Instance,
    value: StructureType,
    buffer: &mut [c_char; MAX_STRUCTURE_NAME_SIZE],
) -> XrResult {
    let string = match value {
